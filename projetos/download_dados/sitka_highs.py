...
ax.plot(dates, highs, c='red') #plota a lista highs em relação às datas usando a função plot() do objeto ax. O argumento c='red' define a cor da linha do gráfico como vermelha

#formata o gráfico
ax.set_title('Temperaturas Máximas Diárias - Sitka, Julho 2021', fontsize=18) #define o título do gráfico do objeto ax
